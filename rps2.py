...
class Game:
    def __init__(self, player1, player2):
        #  Defines two players which are going to play the game
    ...
    def play_round(self):
        ...
        #  Player 2 wins
            ...
            #  Adds one more point0 each time the player wins
    ...
    def play_game(self):
        ...
        for round in range(3):
            ...
            self.play_round()
        print('Game over!\n\n')
        #  Reset the global score to 0 when game ends
...
if __name__ == '__main__':
    ...
    while True:
        ...
        print(
            """This is the ROCK PAPER SCISSORS game with a twist *wink* Here are the rules of the game: \nScissors cuts paper. 
            'Paper covers rock. Rock crushes lizard. Lizard poisons Spock. 
            'Spock smashes scissors. Scissors decapitates lizard. Lizard 
            'eats paper. Paper disproves Spock. Spock vaporizes rock, rock crushes scissors.\n""")
